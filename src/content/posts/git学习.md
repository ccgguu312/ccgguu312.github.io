...
多人项目协作开发：
1、（最常用）在github上打开别人的项目仓库，将其**fork**到自己的仓库中，再**clone**自己仓库的项目到本地进行修改，将修改后的项目提交并推送到自己的github仓库，再点击`pull request`像原仓库管理原发送请求来合并项目。
![doocs](https://img2.nloln.de/file/BQACAgUAAyEGAASLVN5eAAJjKWpeLRrqV7Abbd8yo0f6cbF4iLlPAAIpHwACl9zxVqrohD4rvFLIPQQ.png)

2、先直接**clone**别人的项目到本地，再在github建立一个自己的空仓库，`git remote set-url origin <你的GitHub仓库地址>`修改远程地址再push推送，最后发送请求

> 以上两种情况都还与原项目仓库有联系，但如果clone之后把旧git删掉，重新初始化git，那么这个项目旧和原项目为两个独立的项目了，将无法想原项目发送合并请求，且原项目更新后也不能同步
